...
#ifndef CONFIG_MAX_SYSTEM_DEPENDENCIES
#define CONFIG_MAX_SYSTEM_DEPENDENCIES (CONFIG_MAX_SYSTEM * 4)
#endif
...
namespace mir::config {
	...
	constexpr std::size_t MAX_SYSTEM_DEPENDENCIES = CONFIG_MAX_SYSTEM_DEPENDENCIES;
